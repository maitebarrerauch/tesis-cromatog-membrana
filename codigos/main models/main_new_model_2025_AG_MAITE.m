...
%[x,fval,exitflag,OO,Pop0,SS] = ga(@(x)fopt_2025_escalar(x,yIn,c0,nz,tinyeccion,t,tc),3,[],[],[],[],lb,ub,[],options)
[x,fval,exitflag,OO,population,scores] = ga(@(x)fopt_2025_escalar(x,yIn,c0,nz,tinyeccion,t,tc), ...
                                             3,[],[],[],[],lb,ub,[],options);
 toc
% 
 x_best = x;
 plot_sol(x_best,t,factor_tpo,tinyeccion,c0,nz,tc,yIn)
